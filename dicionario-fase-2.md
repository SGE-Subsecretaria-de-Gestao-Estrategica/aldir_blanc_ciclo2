...
Informações mínimas que caracterizam as ações culturais realizadas, a serem enviadas ao MinC após o encerramento dos Relatórios de Objeto de Execução Cultural de cada edital
...
| **Data de recebimento dos recursos** <br> Data de pagamento dos recursos na conta do projeto. Em caso de parcelamento, inserir data do primeiro pagamento. | Estabelecer o marco inicial financeiro da execução para fins de monitoramento e prestação de contas. | data_recebimento_recurso | Data (dd/mm/aaaa) |
...
| **Tipo de entrega** <br> Classificação da natureza da entrega realizada (ex: relatório, produto cultural, evento). | Categorizar as entregas para avaliação dos resultados da política. | tipo_entrega | Seleção única a partir da [Lista 12. Tipos de Entregas](listas-de-valores.md#12-tipos-de-entregas). |
